...
--  See `:help 'clipboard'`
-- NOTE: I had to install xclip for this to properly work, also some tmux configurations ...
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        -- clangd = {},
        -- gopls = {},
        pyright = { -- NOTE: needs npm installed
          settings = {
            python = {
              analysis = {
  ...
  },
  {
    ...
    event = 'VeryLazy',
    dependencies = { 'msfusseneger/nvim-dap' },
    ---@module 'dap-view'
    ---@typen dapview.Config
    config = function()
      ...
      dap.configurations.python = {
        {
          ...
          program = '${file}',
          pythonPath = function()
            return vim.fn.systemlist('which python')[1]
          end,
        },
      }
      dap.adapters.python = {
